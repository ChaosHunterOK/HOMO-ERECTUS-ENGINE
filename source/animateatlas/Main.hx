...
class Main extends Sprite {
	...
	public function new() {
		...
		var animationData:AnimationData = Json.parse(FNFAssets.getText(SUtil.getPath() + "assets/TEST/Animation.json"));
		var atlasData:AtlasData = Json.parse(FNFAssets.getText(SUtil.getPath() + "assets/TEST/spritemap.json"));
		var bitmapData:BitmapData = FNFAssets.getBitmapData(SUtil.getPath() + "assets/TEST/spritemap.png");
