...
class CustomState extends MusicBeatState
{
	...
	function makeHaxeState(usehaxe:String, path:String, filename:String) {
		...
		interp.variables.set("playSong", playSong);
		...
		interp.variables.set("getDiffName", DifficultyManager.getDiffName);
		interp.variables.set("changeDifficultySans", DifficultyManager.changeDifficultySans);
	...
	public function playSong(songName:String = 'tutorial', difficulty:Int = 1, ?returnState:String = ""):Void
	{
		...
		if (returnState == "") 
			...
			PlayState.customStateName = returnState;
