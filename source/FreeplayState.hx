...
class FreeplayState extends MusicBeatState
{
	...
	override function create()
	{
		...
		if (hscriptStates == null) hscriptStates = new Map<String, Interp>();
		if (haxeSprites == null) haxeSprites = new Map<String, FlxSprite>();
		...
		try {
			...
			trace("Error creating Haxe state: " + e);
	...
	override function update(elapsed:Float)
	{
		...
		try {
			...
			trace("Error in HScript update: " + e);
		}
	}
